...
LOAD_ENVIRONMENT_VARIABLES_SCRIPT="${CONDA_ROOT_DIRECTORY}/Environments/Definitions/${CONDA_ENVIRONMENT_NAME}/Scripts/Bash/Load_Environment_Variables.sh"
...
source "${LOAD_ENVIRONMENT_VARIABLES_SCRIPT}"
...
CONDA_ROOT_DIRECTORY="$(dirname "${CONDARC}")"
CONDA_ENVIRONMENT_NAME="$(basename "${CONDA_PREFIX}")"
UNLOAD_ENVIRONMENT_VARIABLES_SCRIPT="${CONDA_ROOT_DIRECTORY}/Environments/Definitions/${CONDA_ENVIRONMENT_NAME}/Scripts/Bash/Unload_Environment_Variables.sh"
...
source "${UNLOAD_ENVIRONMENT_VARIABLES_SCRIPT}"
